...
class Movie(Base):
    ...
    __table_args__ = (
        UniqueConstraint("code", name="uq_movie_code"),
    )
...
class Actor(Base):
    ...
    __table_args__ = (
        UniqueConstraint("name", "gender", name="uq_actor_name_gender"),
    )
    ...
    movie_links: Mapped[list[MovieActor]] = relationship(back_populates="actor", cascade="all, delete-orphan")
